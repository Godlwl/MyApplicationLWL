...
public class CountDownView extends View {
    ...
    private void init(){
        ...
        mRectText=new Rect();
        textPaint.getTextBounds(text,0,text.length(),mRectText);
...
//        canvas.drawText(TEXT,getWidth()/2-mRectText.width()/2,getHeight()/2+mRectText.height()/2,textPaint);
