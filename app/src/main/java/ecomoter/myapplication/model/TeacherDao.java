...
public class TeacherDao extends AbstractDao<Teacher, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Sexs = new Property(3, String.class, "sexs", false, "SEXS");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Teacher entity) {
        ...
        String sexs = entity.getSexs();
        if (sexs != null) {
            stmt.bindString(4, sexs);
        }
    }
    ...
    public Teacher readEntity(Cursor cursor, int offset) {
        Teacher entity = new Teacher( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3) // sexs
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Teacher entity, int offset) {
        ...
        entity.setSexs(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
     }
