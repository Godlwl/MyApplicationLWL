package com.jl.framework.orm.content;
...
import com.jl.framework.orm.Cache;
import com.jl.framework.orm.Configuration;
import com.jl.framework.orm.Model;
import com.jl.framework.orm.TableInfo;
...
public class ContentProvider extends android.content.ContentProvider {
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		final Class<? extends Model> type = getModelType(uri);
		final Cursor cursor = Cache.openDatabase().query(Cache.getTableName(type), projection, selection, selectionArgs, null, null, sortOrder);
